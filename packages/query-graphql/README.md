...
[![npm version](https://img.shields.io/npm/v/@moogs/query-graphql.svg)](https://www.npmjs.org/package/@moogs/query-graphql)
...
The get started with the `@moogs/query-graphql` package checkout the [Getting Started](https://doug-martin.github.io/nestjs-query/docs/graphql/getting-started) docs.
