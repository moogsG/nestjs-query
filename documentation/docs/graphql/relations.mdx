...
`@moogs-nestjs-query/query-graphql` will then automatically create the following graphql definition:
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, FilterableRelation } from '@moogs-nestjs-query/query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { TodoItemDTO } from '../todo-item/todo-item.dto.ts';
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, FilterableConnection } from '@moogs-nestjs-query/query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { ReadResolver, Relatable } from '@moogs-nestjs-query/query-graphql';
