...
import { QueryService, InjectQueryService } from '@moogs/core';
...
import { NestjsQueryGraphQLModule, PagingStrategies } from '@moogs/query-graphql';
import { NestjsQueryTypeOrmModule } from '@moogs/query-typeorm';
import { Module } from '@nestjs/common';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
import { QueryService, InjectQueryService } from '@moogs/core';
import { CRUDResolver, PagingStrategies } from '@moogs/query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
```ts title="todo-item.resolver.ts"
import { SortDirection, QueryService, InjectQueryService } from '@moogs/core';
import { CRUDResolver } from '@moogs/query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
The `@moogs/query-graphql` package exposes each part of `CRUD` into individual mixins and resolvers allowing you
...
```ts title="todo-item.resolver.ts"
import { QueryService, InjectQueryService } from '@moogs/core';
import { CreateResolver } from '@moogs/query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
```ts title="todo-item.resolver.ts"
import { QueryService, InjectQueryService } from '@moogs/core';
import { ReadResolver } from '@moogs/query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
```ts title="todo-item.resolver.ts"
import { QueryService, InjectQueryService } from '@moogs/core';
import { UpdateResolver } from '@moogs/query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
import { QueryService, InjectQueryService } from '@moogs/core';
import { DeleteResolver } from '@moogs/query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemDTO } from './todo-item.dto';
import { TodoItemEntity } from './todo-item.entity';
...
```ts title="types.ts"
import { ConnectionType, QueryArgsType } from '@moogs/query-graphql';
...
```ts title="todo-item.resolver.ts"
import { Filter, QueryService, InjectQueryService } from '@moogs/core';
import { ConnectionType, CRUDResolver } from '@moogs/query-graphql';
