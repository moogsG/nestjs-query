...
```ts {7-10}
import { FilterableField, BeforeCreateOne, CreateOneInputType } from '@moogs-nestjs-query/query-graphql';
...
```ts {7-11}
import { FilterableField, BeforeCreateMany, CreateManyInputType } from '@moogs-nestjs-query/query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
```ts {7-10}
import { FilterableField, BeforeUpdateOne, UpdateOneInputType } from '@moogs-nestjs-query/query-graphql';
...
```ts {7-10}
import { FilterableField, BeforeUpdateMany, UpdateManyInputType } from '@moogs-nestjs-query/query-graphql';
import { ObjectType } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
