...
import { InjectTypeOrmQueryService } from '@moogs/query-typeorm';
...
In the previous version of `@moogs` the `TypeOrmQueryService` translated between the DTO and Entity. For a more in-depth description see [#41](https://github.com/doug-martin/nestjs-query/issues/41)
...
```ts
import { AssemblerQueryService, QueryService } from '@moogs/core';
import { InjectTypeOrmQueryService } from '@moogs/query-typeorm';
import { TodoItemDTO } from './todo-item.dto';
