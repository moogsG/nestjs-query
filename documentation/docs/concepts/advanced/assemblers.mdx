...
import { Assembler, ClassTransformerAssembler } from '@moogs/core';
...
This method leverages the `transformQuery` function from `@moogs/core`. This method will remap all fields specified in the field map to correct field name.
